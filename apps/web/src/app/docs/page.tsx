        ...
        <div className="grid md:grid-cols-2 gap-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>YOLOv11-powered AI technology</CardDescription>
            </CardHeader>
            <CardContent>
              <p className="text-muted-foreground">
                Advanced object detection using the latest YOLOv11 model, capable of identifying
          ...
          <CardContent className="pt-6">
            <div className="space-y-6">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  Each video frame is analyzed using our custom-trained YOLOv11 model to identify potential hazards
